...
t.test(dati$pressione.placebo, dati$pressione.farmaco, alternative='greater', mu=0, conf.level=0.95)
...
Da studi preliminari, si suppone che il 60% delle famiglie, nella popolazione di riferimento, acquista i prodotti alimentari nei grandi supermercati.
...
```{r es5, echo=FALSE}
prop.test(390, 600, p = 0.6, alternative = "less")
```
